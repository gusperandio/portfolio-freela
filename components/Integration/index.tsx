...
const features = [
  ...
  },
  {
    name: 'Integrações',
    description:
      'As integrações que decidir serão aplicadas, seja o consumo de APIs externas até pagamento vinculando a carteiras digitais',
    icon: Cable,
  },
]
    ...
    <div className="bg-[#020617] py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-cyan-400">Alto desempenho e perforamance</h2>
